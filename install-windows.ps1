...
Write-Host "Setting up configuration..." -ForegroundColor Blue
$envContent = @"
...
docker exec pet-food-store_wordpress wp core install --url=http://localhost:8000 --title="Pet Food Shop" --admin_user=admin --admin_password=admin123 --admin_email=admin@example.com --allow-root
